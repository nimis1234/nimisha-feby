      ...
      <!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h2 class="box-title">Add New Gift Vouchers</h2>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?= base_url()?>index.php/Giftvoucher/add_voucher_action" enctype="multipart/form-data">
            <div class="box-body">
            ...
            <div class="box-footer">
               <span style="padding-left: 530px;">
                  <button type="submit" class="btn btn-info" name="addvoucher">Add</button>
               </span>
            </div>
              <!-- /.box-footer -->
            </form>
