                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                         ...
                         ?>
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?=base_url()?>index.php/Product/update_action/<?=$value['product_id']?>" method="post" enctype="multipart/form-data">

                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Product Name <span class="required"></span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="productname" name="productname" value="<?=$value['productname']?>" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <input type="hidden" name="old" value="<?=$value['product_img']?>">
                                            <img src="<?=base_url()?>Assets/images/product/<?=$value['product_img']?>" height="150" width="150">
                                        </div>
                                    </div>
                                    <?php } ?>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="form-control" name="brandname" id="brand">
                                                    <?php foreach ($brand as $key2 => $value2) { ?>
                                                        ...
                                                        <option value="<?=$value2['brand_id']?>" <?php echo isset($value[ 'brand_id']) && $value[ 'brand_id']==$value2[ 'brand_id'] ? 'selected' : '' ; ?>>
                                                            <?=$value2['brandname']?>
                                                        </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea id="example-textarea-input" rows="5" name="description" required="required" class="form-control col-md-7 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="price" name="price" required="required" value="<?=$value['price']?>" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
