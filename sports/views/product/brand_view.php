                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          ...
                          <!--  <td class="a-center ">
                            ...
                            <td class=" " style="size:50px;"><?=$value['brandname']?></td>
                           <!-- <td class=" "> <i class="success fa fa-long-arrow-up"></i></td>-->
                            <td class=" "><img src="<?=base_url()?>Assets/images/brand/<?=$value['brand_img']?>"></td>
                            <td class=" "><?=$value['brand_des']?></td>
